...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section style={{ backgroundColor: '#9D4815', padding: '2rem' }}>
        <div className='sectionInfo'>
          <div className='sectionInfo2'>
            ...
            >
              <img src='/images/equipe.png' alt='Equipe 1' className='fotoAtras' />
              <img src='/images/equipe2.png' alt='Equipe 2' className='fotoFrente' />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* NOSSOS SERVIÇOS */}
      <section className='servicos' style={{ backgroundColor: '#101820', padding: '2rem' }} id='nossos-servicos'>
      ...
      <section className='cardapio' style={{ backgroundColor: '#5D4A38', padding: '2rem' }} id='cardapio'>
        <h2>CARDÁPIO</h2>
      ...
      {/* FOTOS INSTAGRAM*/}
      <section className='fotos' style={{ backgroundColor: '#9D4815', padding: '2rem' }} id='galeria'>
        <h2>FOTOS</h2>
      ...
      {/* CONTATO*/}
      <section className='contato' style={{ backgroundColor: '#101820', padding: '2rem' }} id='contato'>
        <h2>FALE CONOSCO</h2>
