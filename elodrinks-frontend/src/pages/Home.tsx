  ...
  return (
    <div>
      ...
      >
        <h2>CARDÁPIO</h2>
        <p className="p-texto">
          Selecione o tipo de cardápio que pretende servir para visualizar
        ...
        <div className="flexBoxGeral pt2">
          <div className="grid-2">
            ...
            <p>
              ...
              barbacks, cheffes, copeiras e coordenadores, prontos para garantir
              o sucesso do seu evento ou operação. Entre em contato e saiba como
