...
const imagesCarousel = [
  ...
  { src: 'src/images/empresa2.webp', alt: 'Logo da Empresa 2' },
  { src: 'src/images/empresa3.webp', alt: 'Logo da Empresa 3' },
  { src: 'src/images/empresa4.webp', alt: 'Logo da Empresa 4' },
  { src: 'src/images/empresa5.webp', alt: 'Logo da Empresa 5' },
  { src: 'src/images/empresa6.webp', alt: 'Logo da Empresa 6' },
  { src: 'src/images/empresa7.webp', alt: 'Logo da Empresa 7' },
  { src: 'src/images/empresa8.webp', alt: 'Logo da Empresa 8' },
  { src: 'src/images/empresa9.webp', alt: 'Logo da Empresa 9' },
  { src: 'src/images/empresa10.webp', alt: 'Logo da Empresa 10' }
];
